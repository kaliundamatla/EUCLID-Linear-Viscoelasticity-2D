"""
Geometry configuration for Experiment 808: Three circular holes

This configuration defines a rectangular specimen with three circular holes
arranged vertically with a small-large-small pattern.
"""

EXPERIMENT_CONFIG = {
    'id': 808,
    'name': 'Three_Circular_Holes',
    'description': 'Three circular holes (small-large-small) vertically arranged',
